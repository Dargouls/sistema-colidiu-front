      ...
      <>
        <Label>
          <span style={{ fontSize: 20, fontWeight: "bold" }}>
            Dados dos demais Veículos (adicione até 5 veículos com exceção do
            que foi informado na aba "Veículo e Você")
          </span>
        </Label>
        {this.props.state.array_vehicle.map((item, index) => (
          ...
          >
            ...
            <FormGroup>
              ...
              <Input type="select" name="airbag" disabled value={item.airbag}>
                <option></option>
                <option>Sim</option>
                <option>Não</option>
              </Input>
            ...
            <FormGroup>
              <Label>Sexo</Label>
              <Input type="select" name="sex" value={item.sex} disabled>
                <option></option>
            ...
            <FormGroup check className="radio">
              ...
              />
              <Label>
                Não houve a possibilidade de coletar dados do condutor{" "}
              </Label>
            </FormGroup>

            <Label>
              <span style={{ fontSize: 20, fontWeight: "bold" }}>
                Endereço do Condutor / Responsável
              </span>
              <span> (O preenchimento destes campos não são obrigatórios)</span>
            </Label>
            ...
            {this.state.isMoreAuthors === "true" && (
              <>
                ...
                <Label>
                  ...
                  <span>
                    {" "}
                    (O preenchimento destes campos não são obrigatórios)
                  </span>
                </Label>
                ...
                <FormGroup check className="radio">
                  <Input
                    ...
                    onChange={() => {
                      console.log(this.state.data_conductor);
                      this.setState({
                        data_conductor: !this.state.data_conductor,
                      });
                    }}
                  />
                  <Label>
